...
export type MemberCardProps = {
  ...
  href?: string
  colorScheme?: 'dark' | 'blue' | 'purple' | 'red'
...
const Component = forwardRef<HTMLElement, MemberCardProps & MemberCardImage>(
  (
    {
      width,
    ...
    return (
      ...
      >
        ...
        >
          ...
          {icon && (
            <Box display="flex" alignItems="center" className={styles.icon}>
              {icon}
            </Box>
          )}
        </Box>
...
export const MemberCard = (props: MemberCardProps & MemberCardImage) => {
